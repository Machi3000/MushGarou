...
function m_thisInit() {
    ...
    +'<h3><img src="http://www.hordes.fr/gfx/forum/smiley/h_shaman.gif" /> Mush Garou</h3>'
	...
	$('#m_garou_details').html('Partie #MG157894<br />'
	+'Votre rôle : <strong><img src="http://mush.vg/img/icons/ui/mushxp.png" /> Mush Garou</strong><br />'
	+'Vous devez arriver à tuer tous les humains à bord sans vous faire tuer.<br />'
	+'<a href="#">Rappel des règles du Mush Garou</a><br />'
	+''
	+''
	+'');
